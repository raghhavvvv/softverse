      ...
      <ParallaxSection speed={0.3} className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="text-center">
          <ScrollAnimationWrapper animation="fadeIn" delay={0}>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 font-inter tracking-tight">
              ...
              <span className="block text-white text-2xl md:text-3xl">FOR A CONNECTED FUTURE</span>
            </h1>
